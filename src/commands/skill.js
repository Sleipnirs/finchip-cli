...
function configurePublish(command) {
  return command
    ...
    .option('--summary <text>', 'Short problem, outcome, and boundary summary (required)')
    .option('--description <text>', 'Capability fit contract: problem, outcome, capabilities, non-matches, requirements, outputs, limits, and side effects')
